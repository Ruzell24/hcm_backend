...
var _security = _interopRequireDefault(require("../../../service/utils/security"));
var _jwt = _interopRequireDefault(require("../../../service/authenticator/jwt"));
...
var userLogin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var body, user, passwordMatches, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          _context.next = 11;
          return _security["default"].decrypt_password(body.password, user.password);
        case 11:
        ...
        case 14:
          token = _jwt["default"].generateToken(user);
          res.status(200).json({
            user: {
              id: user.id,
...
var userSignUp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var body, password, isUserExist, user;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          _context2.next = 6;
          return _security["default"].encrypt_password(body.password);
        case 6:
...
var getUserDetails = function getUserDetails(req, res) {
  ...
  try {
    var user = _jwt["default"].authenticateToken(token);
    res.json({
      user: user
    });
  } catch (error) {
